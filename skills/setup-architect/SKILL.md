...
**Copy only these files** from `.architecture/.architecture/.architecture/`:
...
- `templates/deferrals.md` → `deferrals.md` - deferral tracking (copy from templates, not root)
- `agent_docs/` - workflow and reference documentation

**Do NOT copy** (framework internals/examples):
- `decisions/adrs/ADR-*` - framework's own ADRs
- `reviews/*` - framework's example reviews
- `deferrals.md` - framework's deferral log
- `documentation-*.md` - framework internal docs
- `instruction-counting-methodology.md`
- `quarterly-review-process.md`
- `recalibration_process.md`
- `comparisons/*` - framework comparisons
- `recalibration/*` - framework recalibration docs

**Do NOT copy from clone root**:
- `AGENTS.md` - framework documentation
- `.coding-assistants/` - multi-assistant configs
